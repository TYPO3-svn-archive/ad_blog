...
/**
 * Test case for class \AD\AdBlog\Domain\Model\Article.
 *
 * @version $Id$
...
class ArticleTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var \AD\AdBlog\Domain\Model\Article
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new \AD\AdBlog\Domain\Model\Article();
	}
	...
	public function setCategoriesForObjectStorageContainingCategorySetsCategories() { 
		$category = new \AD\AdBlog\Domain\Model\Category();
	...
	public function setAuthorForObjectStorageContainingAuthorSetsAuthor() { 
		$author = new \AD\AdBlog\Domain\Model\Author();
