...
class CategoriesController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	 ...
	 * action new
	 *
	 * @param \AD\AdBlog\Domain\Model\Categories $newCategories
	 * @dontvalidate $newCategories
	 * @return void
	 */
	public function newAction(\AD\AdBlog\Domain\Model\Categories $newCategories = NULL) {
	 ...
	 * @return void
	 */
	public function createAction(\AD\AdBlog\Domain\Model\Categories $newCategories) {
		$this->categoriesRepository->add($newCategories);
		$this->flashMessageContainer->add('Your new Categories was created.');
		$this->redirect('list');
	}
